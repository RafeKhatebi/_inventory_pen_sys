    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control @error('package_type') is-invalid @enderror" 
                   id="package_type" name="package_type" value="{{ old('package_type', $product->package_type ?? '') }}" required>
            @error('package_type')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
...
<div class="mb-4">
        ...
        <div class="col-md-6 mb-3">
            ...
            <div class="input-group">
                ...
                <input type="number" step="0.01" class="form-control @error('price_per_carton') is-invalid @enderror" 
                       id="price_per_carton" name="price_per_carton" value="{{ old('price_per_carton', $product->price_per_carton ?? '') }}" required>
            </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <label for="quantity_per_carton" class="form-label">Quantity Per Carton *</label>
            <input type="number" class="form-control @error('quantity_per_carton') is-invalid @enderror" 
                   id="quantity_per_carton" name="quantity_per_carton" value="{{ old('quantity_per_carton', $product->quantity_per_carton ?? '') }}" required>
